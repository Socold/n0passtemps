...
// The sealed record and bulk revocation tests mirror the SQLite ones, for the
// reason the rest of this suite exists: the two engines must not be
// distinguishable from outside, and the compare-and-swap in particular is
// written differently here. See postgres_test.go for how the suite is pointed
// at a cluster.
