...
-- Postgres offers a better one. Timestamps are TIMESTAMPTZ rather than RFC3339
-- strings, so the expiry probe and the janitor sweep are range scans rather than
